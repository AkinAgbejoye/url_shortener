    ...
    <body class="min-h-screen bg-slate-950 font-sans text-white antialiased">
        <div class="relative isolate min-h-screen overflow-hidden">
            ...
            <main class="mx-auto flex w-full max-w-6xl flex-col items-center px-5 pb-16 pt-14 text-center sm:px-8 sm:pt-20 lg:px-10 lg:pt-24">
                ...
                <p class="mt-6 max-w-2xl text-pretty text-base leading-7 text-slate-300 sm:text-lg">Paste a long URL and get a clean, shareable link in seconds. No account required.</p>
                ...
                <section class="mt-10 w-full max-w-3xl" aria-labelledby="shortener-heading">
                    ...
                    <form class="rounded-2xl border border-white/10 bg-white/[0.07] p-3 shadow-2xl shadow-black/20 backdrop-blur sm:flex sm:items-end sm:gap-3 sm:p-4">
                        ...
                        <button type="submit" class="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-blue-500 px-6 py-4 text-base font-semibold text-white shadow-lg shadow-blue-500/20 transition hover:bg-blue-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300 sm:mt-0 sm:w-auto">
                            Shorten URL
                    ...
                    <div id="short-url-result" class="mt-8" aria-live="polite" aria-atomic="true"></div>
                </section>

                <div class="mt-16 grid w-full max-w-3xl gap-4 text-left sm:grid-cols-3">
                    <div class="rounded-2xl border border-white/10 bg-white/[0.04] p-5"><p class="text-sm font-semibold text-white">Instant</p><p class="mt-1 text-sm leading-6 text-slate-400">Generate compact links without waiting or signing up.</p></div>
                    <div class="rounded-2xl border border-white/10 bg-white/[0.04] p-5"><p class="text-sm font-semibold text-white">Resilient</p><p class="mt-1 text-sm leading-6 text-slate-400">Database-backed redirects keep working through cache failures.</p></div>
                    <div class="rounded-2xl border border-white/10 bg-white/[0.04] p-5"><p class="text-sm font-semibold text-white">Private</p><p class="mt-1 text-sm leading-6 text-slate-400">No tracking scripts and no account needed to shorten a link.</p></div>
                </div>
            </main>

            <footer class="mx-auto w-full max-w-6xl px-5 pb-8 text-center text-sm text-slate-500 sm:px-8 lg:px-10">Built with Laravel and a focus on reliable redirects.</footer>
        </div>
    </body>
</html>
